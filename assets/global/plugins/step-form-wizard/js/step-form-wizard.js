...
(function($) {
    ...
    var defaults = {
        ...
        finishBtn: $('<button type="submit" class="finish-btn sf-right sf-btn"><i class="fa fa-spinner faa-spin animated hide" id="loadIcon"></i> FINISH</button>'),
        //finishBtn: $('<input class="finish-btn sf-right sf-btn" type="submit" value="FINISH" id="btnFinish"/>'),
    ...
    stepFormWizard.prototype.goTo = function(index) {
        ...
        if(this.config.height == 'auto' && this.steps.length) {
            ...
            //
            if(height > 330 && this.stepActive == 1){
                height = 330;
            }
            //
