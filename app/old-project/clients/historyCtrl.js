angular.module('newApp')
    .controller('historyCtrl', ['$scope', '$location', 'config', '$http', '$routeParams', function ($scope, $location, config, $http, $routeParams) {
        ...
        //ailments
        $scope.ailments = [];
        $http.get(config.ip + '/api/Ailments')
        ...
        $scope.save = function () {
            ...
            if ($scope.checkUnchangedFields.apply(this, arguments)) {
                ...
                $http.put(config.ip + '/api/Clients/' + $scope.id, client_put_resquest)
                    .success(function (result) {
                        console.log(result);
                    })
                    .error(function (data, status) {
        ...
        $scope.verifiedAdd = function () {
            ...
            $http.post(config.ip + '/api/AilmentsbyClient', post_resquest)
                .success(function (result) {
                    console.log(result);
                })
                .error(function (data, status) {
        ...
        $scope.remove = function (index, index_aux) {
            ...
            if (confirm("Are you sure to delete this row?") == true) {
                ...
                $http.delete(config.ip + '/api/AilmentsbyClient?id_ailment='+$scope.items[i].id_ailment+"&id_client="+$scope.id)
                    .success(function (result) {
                        console.log(result);
                    })
                    .error(function (data, status) {
        ...
        $http.get(config.ip + '/api/Clients/'+$scope.id)
            .success(function (result) {
                $scope.client = result;
